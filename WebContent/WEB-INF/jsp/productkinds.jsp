        ...
        <div class="main">
            ...
            <div class="tuijian">
                ...
                <div class="tuijian_product" style="min-width: 750px;">
                	<c:forEach items="${productList }" var="pro">
	                    ...
	                    <div style="float:left; margin: 10px 30px;">
	                        ...
	                        <br>
	                        <a href="${pageContext.request.contextPath }/findProductById?id=${pro.id}">查看详细</a>
	                        <br>
				...
				<c:if test="${pages.page gt 1}">
					<a href="${pageContext.request.contextPath }/showProductkinds?type=${type }&amp;page=${pages.page-1}"><button type="button" id="up"
					...
					<a href="${pageContext.request.contextPath }/showProductkinds?type=${type }&amp;page=${pages.page+1}"><button type="button" id="down"
