								...
								<tbody>
									...
									<c:forEach items="${productslist }" var="pro" varStatus="count">
										...
										<tr>
											...
											<td><img src="${pageContext.request.contextPath }/${pro.imgurl} " height="30"></td>
											<td>${pro.cbtime }</td>
											<td>${pro.state }</td>

											<td><a href="${pageContext.request.contextPath }/showEditProduct?id=${pro.id}&amp;imgurl=${pro.imgurl}"> <i class="fa fa-edit text-navy"></i>
											</a> <a href="#" onclick="delProduct('${pro.id}')">
