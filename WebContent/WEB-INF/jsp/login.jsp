    ...
    <div class="estore_content" style="min-height: 800px;">
        <div class="header">
            ...
            <div class="estore" align="center">
                <h1
					style="font-size:35px;text-align:center;padding-top:80px;color: #87520E;">Estore
                    <br />图书商城
                </h1>
            ...
            <table>
                ...
                <tr>
                    <td colspan="2">
						...
						id="remember" value="on" style="width: 25px;line-height: 35px;" />记住用户 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="checkbox" name="autologin"
						value="on" style="width: 25px" />自动登录
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
